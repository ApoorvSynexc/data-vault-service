...
// AWS EMR
const AWS_EMR_REGION = String(process.env.AWS_EMR_REGION || 'us-east-2');
...
const AWS_EMR_ACCESS_KEY_ID = String(process.env.AWS_EMR_ACCESS_KEY_ID);
const AWS_EMR_SECRET_ACCESS_KEY = String(process.env.AWS_EMR_SECRET_ACCESS_KEY);
...
export {
  ...
  AWS_EMR_ACCESS_KEY_ID,
  AWS_EMR_SECRET_ACCESS_KEY,
