...
const USER_TABLE = String(process.env.USER_TABLE || `${NODE_ENV_PREFIX}-data-vault-users`);
const OTP_TABLE = String(process.env.OTP_TABLE || `${NODE_ENV_PREFIX}-data-vault-otps`);
const SESSION_TABLE = String(process.env.SESSION_TABLE || `${NODE_ENV_PREFIX}-data-vault-sessions`);
const ROLE_TABLE = String(process.env.ROLE_TABLE || `${NODE_ENV_PREFIX}-data-vault-roles`);
const TABLE_COUNTER_TABLE = String(process.env.TABLE_COUNTER_TABLE || `${NODE_ENV_PREFIX}-data-vault-table-counters`);
const COUNTER_TABLE = String(process.env.COUNTER_TABLE || `${NODE_ENV_PREFIX}-data-vault-counters`);
...
const OAUTH_STATE_TABLE = String(process.env.OAUTH_STATE_TABLE || `${NODE_ENV_PREFIX}-data-vault-oauth-states`);
...
const DESTINATION_TABLE = String(process.env.DESTINATION_TABLE || `${NODE_ENV_PREFIX}-data-vault-destinations`);
...
const SPACE_TABLE = String(process.env.SPACE_TABLE || `${NODE_ENV_PREFIX}-data-vault-spaces`);
