...
| src/services/restore-retrieve/restore-csv.ts | Pure serialiser for the Bulk API ingest CSV — Id/delete handling per restoreMode (added 2026-07-30, has a self-check) |
